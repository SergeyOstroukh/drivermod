...
CREATE TABLE IF NOT EXISTS public.vehicles (
    ...
    oil_change_interval INTEGER, -- в км
...
CREATE POLICY "Allow anonymous read access" ON public.vehicles
    FOR SELECT USING (true);

CREATE POLICY "Allow anonymous insert access" ON public.vehicles
    FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow anonymous update access" ON public.vehicles
    FOR UPDATE USING (true);

CREATE POLICY "Allow anonymous delete access" ON public.vehicles
