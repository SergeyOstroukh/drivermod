...
-- Функция для автоматического обновления updated_at в истории
...
CREATE POLICY "Allow anonymous read access" ON public.vehicle_driver_history FOR SELECT USING (true);
CREATE POLICY "Allow anonymous insert access" ON public.vehicle_driver_history FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow anonymous update access" ON public.vehicle_driver_history FOR UPDATE USING (true);
CREATE POLICY "Allow anonymous delete access" ON public.vehicle_driver_history FOR DELETE USING (true);
